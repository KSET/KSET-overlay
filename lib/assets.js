...
const $styles = [
    ...
    {
        name: 'index',
        file: path.resolve(__dirname, '../static/css/index.scss'),
        out: path.resolve(__dirname, '../public/css/index.css'),
        link: `${baseUrl}/css/index.css`,
        action: compileSCSS,
    },
];
...
const $scripts = [
    ...
    {
        name: 'index',
        file: path.resolve(__dirname, '../static/js/index.js'),
        out: path.resolve(__dirname, '../public/js/index.js'),
        link: `${baseUrl}/js/index.js`,
        action: compileJS,
    },
];
