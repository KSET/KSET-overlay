...
module.exports = class Settings {
    ...
    get publicSettings() {
        const { defaultUrl, maxMessageLength } = this;

        return { defaultUrl, maxMessageLength };
    }

    get changeableSettings() {
        return [ 'maxMessageLength', 'defaultUrl', 'password' ];
    }
    ...
    inspect(depth, opts) {
        const { host, port, defaultUrl, password, baseUrl, maxMessageLength } = this;

        return { host, port, defaultUrl, password, baseUrl, maxMessageLength };
    }
};
